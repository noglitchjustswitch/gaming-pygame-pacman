# Build Pac-Man Plus from Scratch in Python with Pygame!!
import copy
...
pygame.display.set_caption('Pac-Man Plus')
...
spooked_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/powerplus1.png'), (45, 45))
spooked_white_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/powerpluswhite.png'), (45, 45))
...
cherry_img = pygame.transform.scale(pygame.image.load(f'assets/fruits/cola.png'), (45, 45))
...
while run:
    ...
    screen.fill('black')
    color = draw_board(toggle_color(color))
    ...
    if cherry_collected:
        cherry_timer += dt
        powerup = True
        spooked_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/invisible.png'), (45, 45))
        spooked_white_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/invisible.png'), (45, 45))
    else:
        spooked_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/powerplus1.png'), (45, 45))
        spooked_white_img = pygame.transform.scale(pygame.image.load(f'assets/ghost_images/powerpluswhite.png'), (45, 45))
